...
def count_product(selected_product_name, selected_item, conn_str):
    ...
    # Initialize product_quantity in session state if not already set
    ...
    product_quantity = st.number_input("กรุณากรอกยอดสินค้าที่ตรวจนับได้", min_value=None, value=0, step=1, key='product_quantity_input')
